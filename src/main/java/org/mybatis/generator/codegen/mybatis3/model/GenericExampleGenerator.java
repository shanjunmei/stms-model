 ...
 * 
 */
public class GenericExampleGenerator extends AbstractJavaGenerator {

    public GenericExampleGenerator() {
        super();
    }
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType("com.ffzx.orm.common.GenericExample");
        type.addTypeArgument(new FullyQualifiedJavaType("T"));
      ...
      /*  method = new Method();
        ...
        method.addBodyLine("GeneratedCriteria criteria = createCriteriaInternal();"); //$NON-NLS-1$
        method.addBodyLine("oredCriteria.add(criteria);"); //$NON-NLS-1$
